...
CKEDITOR.dialog.add( 'scaytDialog', function( editor ) {
	...
	var aboutTabDefinition = '<p><img src="' + scayt_instance.getLogo() + '" /></p>' +
				...
				'<p><a href="http://scayt.com/user_manual/spellex_scayt_plugin_for_ckeditor4_user_manual.pdf" target="_blank" style="text-decoration: underline; color: blue;">' + scayt_instance.getLocal('btn_userManual') + '</a></p>' +
